        ...
        <>
         <div className="h-[646.95px] left-[26.91px] top-[314.94px] absolute">
            <div className="w-[492.34px] h-[407.75px] left-0 top-[239.19px] absolute">
                ...
                <img className="w-[229.23px] h-[229.23px] left-0 top-[-225px] absolute rounded-[5px]" src="https://assets.scrimba.com/advanced-react/react-router/modest-explorer.png" />
                    ...
                    <div className="Group204 w-[85.71px] h-[33.89px] top-9 relative">
